...
class ObjectViewedManager(models.Manager):
	...
	def filter_by_instance(self, instance):
		...
		obj_id = instance.id 
		qs = super(ObjectViewedManager, self).filter(content_type=content_type, object_id=obj_id)
		return qs
...
class ObjectViewed(models.Model):
	...
	ip_address		= models.CharField(max_length=250, blank=True, null=True) #IP field
	content_type	= models.ForeignKey(ContentType, on_delete=models.CASCADE) #models:User Product, Order, Cart, Address ...
