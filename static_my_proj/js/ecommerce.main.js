$(document).ready(function(){
  ...
  var strpeModuleBtnTitle = stripeFormModule.attr("data-btn-tilte") || "Add card"
...
//   // display new btn ui
//   var loadTime = 1500
//   var errorHtml   = "<i class='fa fa-warning'> An error occured"
//   var errorClasses = "btn btn-danger  disabled my-3"
//   var loadingHtml   = "<i class='fa fa-spin fa-spinner'> Loadind... "
//   var loadingClasses = "btn btn-succcess  disabled my-3"
...
form.on('submit', function(event) {
  ...
  var errorClasses = "btn btn-danger  disabled my-3"
  var loadingHtml   = "<i class='fa fa-spin fa-spinner'></i> Loadind... "
  ...
  function stripeTokenHandler(nextUrl,token){
  	...
  	$.ajax({
  		...
  		success: function(data){
  			var successMsg = data.message || "Success! Your card was added here."
  			card.clear()
  			if(nextUrl){
        ...
        btnLoad.attr("class", btnLoadDefaultClasses)
  		...
  		error: function(error){
  			console.log(error)
        $.alert({title:"An error occured", content:"Please try adding your again." })
        btnLoad.html(btnLoadDefaultHtml)
        btnLoad.attr("class", btnLoadDefaultClasses)
  		}
