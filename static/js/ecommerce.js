      ...
      productFormAdd.submit(function(event){
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              if (data.added){
                submitSpan.html("<a href='{% url 'carts:home' %}' class='btn btn-primary' style='margin: 7px;'><i class='fa fa-shopping-cart inner-right-vs'>VOIR DANS LE PANIER</i></a>|<button type='submit' class='btn btn-primary' style='margin: 7px;'><i class='fa fa-shopping-cart inner-right-vs'></i>AUGMENTER LA QUANTITE</a>")
              }
              else{
      ...
      productFormDelete.submit(function(event){
          ...
          $.ajax({
            ...
            success: function(data){
              var submitSpan = thisForm.find(".submit-span")
              if (data.deleted){
                submitSpan.html("<a href='{% url 'carts:home' %}' class='btn btn-primary' style='margin: 7px;'><i class='fa fa-shopping-cart inner-right-vs'>VOIR DANS LE PANIER</i></a>|<button type='submit' class='btn btn-primary' style='margin: 7px;'><i class='fa fa-shopping-cart inner-right-vs'></i>ENLEVER DU PANIER</a>")
              }
              else{
                submitSpan.html("<button type='submit' class='btn btn-primary'><i class='fa fa-shopping-cart inner-right-vs'></i>PAYER MAINTENANT</button>")
              }
