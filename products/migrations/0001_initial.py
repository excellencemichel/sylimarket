# Generated by Django 2.0.7 on 2019-12-15 00:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotion', models.DecimalField(decimal_places=2, max_digits=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tranche', models.CharField(choices=[('allage', 'Pour tous les âges'), ('moins40', 'Moins de 40 ans'), ('moins20', 'Moins de 20 ans'), ('plus40', 'Plus de 40 ans'), ('moins12', 'Moins de 12 ans')], max_length=250)),
                ('clothing_type', models.CharField(choices=[('shirt', 'Chemise'), ('tshirt', 'T-Shirt'), ('jacket', 'Jacket'), ('bluson', 'Blouson'), ('pull', 'Pulls'), ('polo', 'Polo'), ('maillot', 'Maillot'), ('gilet', 'Gilet')], max_length=250)),
            ],
            options={
